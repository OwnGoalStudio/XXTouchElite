---
authors: lessica
tags: [imap4, mail, email, lua]
---

# Read Mails with IMAP4 Protocol

The [IMAP4](https://tools.ietf.org/html/rfc3501) protocol is a standard for accessing email on a remote server. It allows you to read, delete, and organize your emails without downloading them to your local machine.

<!-- truncate -->

```lua title="imap4-example.lua" showLineNumbers
