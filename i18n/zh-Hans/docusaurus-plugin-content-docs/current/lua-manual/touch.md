...
- 横坐标, 纵坐标
  - *整数型*，需要轻触的点于当前 [旋转坐标系](screen.mdx#初始化旋转坐标系-screeninit) 的坐标
- 延迟毫秒
...
- 横坐标, 纵坐标
  - *整数型*，需要接触的点于当前 [旋转坐标系](screen.mdx#初始化旋转坐标系-screeninit) 的坐标
- 触摸事件 *触摸事件对象*
...
- 横坐标, 纵坐标
  - *整数型*，*可选*，手指离开屏幕的点于当前 [旋转坐标系](screen.mdx#初始化旋转坐标系-screeninit) 的坐标，默认为当前 *触摸事件对象* 记录的坐标
- 触摸事件
...
- 横坐标, 纵坐标
  - *整数型*，需要移动至的点于当前 [旋转坐标系](screen.mdx#初始化旋转坐标系-screeninit) 的坐标
- 压力
...
设置当前触摸事件对象使用 [`touch:move`](#模拟手指在屏幕上移动-touchmove) 方法滑动的每步延迟。
...
设置当前触摸事件对象使用 [`touch:move`](#模拟手指在屏幕上移动-touchmove) 方法滑动的步长。
