...
#### [Refer to `screen.is_colors` description](screen.mdx#-multi-point-color-matching-screenis_colors)
...
#### [Refer to `screen.find_color` description](screen.mdx#-multi-point-similarity-mode-find-color-screenfind_color)
...
This function is similar to the [`screen.find_image`](screen.mdx#-find-image-on-screen-screenfind_image) function, but this function finds an image within another image, while the former finds an image on the screen. Other differences are as follows:
...
#### [Refer to `screen.ocr_text` description](screen.mdx#-optical-character-recognition-ocr-screenocr_text)
...
#### [Refer to `screen.tess_ocr` description](screen.mdx#-tesseract-optical-character-recognition-ocr-screentess_ocr)
...
#### [Refer to `screen.qr_decode` description](screen.mdx#-qr-code-recognition-screenqr_decode)
...
#### [Refer to `screen.detect_rectangles` description](screen.mdx#-rectangle-detection-screendetect_rectangles)
